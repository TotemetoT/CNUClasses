...
class ReinforcementAgent(ValueEstimationAgent):
      ...
      Abstract Reinforcemnt Agent: A ValueEstimationAgent
        ...
        What you need to know:
                    - The environment will call
                      observe_transition(state,action,next_state,deltaReward),
                      which will call update(state, action, next_state, deltaReward)
    ...
    def __init__(self, actionFn=None, num_training=100, epsilon=0.5, alpha=0.5, gamma=1):
        """
        actionFn: Function which takes a state and return_val the list of legal actions
