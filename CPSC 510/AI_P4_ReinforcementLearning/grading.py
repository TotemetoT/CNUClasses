...
class Grades:
    ...
    def __init__(self, project_name, questions_and_maxes_list, gs_output=False, edx_output=False,
                 mute_output=False):
        """
    ...
    def add_prereq(self, question, prerequisite):
        self.prerequisites[question].add(prerequisite)
    ...
    def grade(self, grading_module, exception_map={}, bonus_pic=False):
        ...
        for q in self.questions:
            ...
            incomplete = self.prerequisites[q].difference(completed_questions)
            if incomplete:
                prerequisite = incomplete.pop()
                print(
                    f'*** NOTE: Make sure to complete Question {prerequisite} before working '
                    f'on Question {q},\n'
                    f'*** because Question {q} builds upon your answer '
                    f'for Question {prerequisite}.')
                continue
            ...
            try:
                ...
                # Call the question's function
                # TimeoutFunction(getattr(grading_module, q),1200)(self)
        ...
        if bonus_pic and self.points.total_count() == 25:
            print("""
                     ...
                     ALL HAIL GRAND-PAC.
              LONG LIVE THE GHOST BUSTING KING.
...
""")
        print(f'Your grades are NOT yet registered. To register your grades, make sure to\n'
              f'follow your instructor\'s guidelines to receive credit on your project.')
    ...
    def add_exception_message(self, q, inst, trace_back):
        """
    ...
    """
        ...
        self.add_message('')
        for line in trace_back.format_exc().split('\n'):
    ...
    @staticmethod
    def add_message_to_email(message):
