...
class EightPuzzleState:
    ...
    def result(self, move):
        ...
        NOTE: This function *does not* change the current this_ojb.  Instead,
        it returns a new this_ojb.
        """
        row, col = self.blank_location
        if move == 'up':
            new_row = row - 1
...
class EightPuzzleSearchProblem(search.SearchProblem):
    ...
    def get_cost_of_actions(self, actions):
        ...
        This method returns the total row_line of a particular sequence of actions.
...
def load_eight_puzzle(puzzle_number):
    """
      ...
      Returns an eight puzzle this_ojb generated from one of the
