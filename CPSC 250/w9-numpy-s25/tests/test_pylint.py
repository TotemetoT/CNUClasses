...
class TestPyLint(unittest.TestCase):
        ...
        with redirect_stdout(actual_output):
            try:
                args = [
                    ...
                    '--max-line-length=150',
                    '--good-names='+','.join(['degs', 'rads', 'cos', 'fig', 'relative_file_path',
                                              'x', 'y', 'y2', 'n', 'r', 'x_rand', 'x_np',
                                              'rc', 'xc', 'yc', 'pi_a', 'n_range', 'pi_values',
                                              'c0', 'c1', 'c2', 'c3', 'mx', 'i', 'fpath', 'new_max',
                                              'file_path', 'writer', 'reader', 'n2', 'n3', 'nexp',
                                              'logn', 'nlog', 'nlogn']),
                    '--persistent=n',
                ]
    ...
    def test_angles_module_style(self):
        self.lint_test(self.__path+"angles_module.py")

    def test_plot_sine_module_style(self):
        self.lint_test(self.__path+"plot_sine_module.py")

    def test_monte_carlo_pi_style(self):
        self.lint_test(self.__path+"monte_carlo_pi.py")

    def test_homework_numpy(self):
        self.lint_test(self.__path+"homework_numpy.py")

    def test_homework_game(self):
        self.lint_test(self.__path+"game.py")

    def test_homework_read_characters(self):
        self.lint_test(self.__path+"read_characters.py")
