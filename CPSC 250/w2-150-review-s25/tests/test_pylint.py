...
class TestPyLint(unittest.TestCase):
    ...
    def test_odd(self):
        self.lint_test(self.__path+"odd.py")

    def test_int_calc(self):
        self.lint_test(self.__path+"int_calc.py")

    def test_copy_list(self):
        self.lint_test(self.__path+"copy_list.py")

    def test_homework(self):
        self.lint_test(self.__path+"homework.py")

    def test_homework_review(self):
        self.lint_test(self.__path+"homework_review.py")
