...
class TestPyLint(unittest.TestCase):
    ...
    def test_car_style(self):
        self.lint_test(self.__path+"car.py")

    def test_car_factory_style(self):
        self.lint_test(self.__path+"car_factory.py")

    def test_person_style(self):
        self.lint_test(self.__path+"person.py")

    def test_person_factory_style(self):
        self.lint_test(self.__path+"person_factory.py")

    def test_homework_style(self):
        self.lint_test(self.__path+"homework.py")

    def test_planet_style(self):
        self.lint_test(self.__path+"planet.py")

    def test_planet_factory_style(self):
        self.lint_test(self.__path+"planet_factory.py")
