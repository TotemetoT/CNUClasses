...
class TestCsvDataMethods(unittest.TestCase):
    """
        Test Class for csv_data.py
    """
    ...
    def test_read_data_1(self):
        ...
        act_c0,act_c1,act_c2 = csv_data.read_data_csv(self.small_data_file)
    ...
    def test_read_data_2(self):
        ...
        act_c0,act_c1,act_c2 = csv_data.read_data_csv(self.small_data_file2)
    ...
    def test_read_data_tmp(self):
        ...
        # Test the metho
        act_c0,act_c1,act_c2 = csv_data.read_data_csv(self.small_data_tmp_file)
    ...
    def test_append_data_tmp(self):
        ...
        # Test the metho
        new_lines = csv_data.append_data_csv(self.small_data_tmp_file, max_val)
