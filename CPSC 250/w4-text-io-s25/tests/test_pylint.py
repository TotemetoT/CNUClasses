...
class TestPyLint(unittest.TestCase):
        ...
        with redirect_stdout(actual_output):
            try:
                args = [
                    ...
                    '--max-line-length=150',
                    '--good-names='+','.join(['c0','c1','c2','c3', 'ch', 'i','mx','n', 'x', 'num_lines', 'file_path',
    ...
    def test_homework_review_style(self):
        self.lint_test(self.__path+"homework.py")

    def test_homework_text_io_style(self):
        self.lint_test(self.__path+"homework_file_io.py")

    def test_small_data_style(self):
        self.lint_test(self.__path+"small_data.py")

    def test_csv_data_style(self):
        self.lint_test(self.__path+"csv_data.py")
